...
**Download [tmux 3.4 here](https://github.com/tmux/tmux/releases/download/3.4/tmux-3.4.tar.gz)**
([changes in this version](https://raw.githubusercontent.com/tmux/tmux/3.4/CHANGES)).
