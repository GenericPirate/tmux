...
**Download [tmux 3.3 here](https://github.com/tmux/tmux/releases/download/3.3/tmux-3.3.tar.gz)**
([changes in this version](https://raw.githubusercontent.com/tmux/tmux/3.3/CHANGES)).
